...
class NonnyNavScreen extends Component {
  render() {
    const campusMap = require("../../screenImages/nonnyNav.png"); 
    return (
      <View style={styles.container}>
        <Text>You are on the Nonny Nav Screen page</Text>   
