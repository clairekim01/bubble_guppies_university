...
class NonnyNoneScreen extends Component {
  render() {
    const campusMap = require("../../screenImages/academicFloorPlanMain.png"); 
    return (
      <View style={styles.container}>
        ...
        <Button
            title="View on Map"
            onPress={() => this.props.navigation.navigate('NonnyNav')}
        /> 
         <Button
            title="Back to home"
...
export default NonnyNoneScreen;