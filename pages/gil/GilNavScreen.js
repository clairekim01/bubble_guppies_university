...
class GilNavScreen extends Component {
  render() {
    const campusMap = require("../../screenImages/gilNav.png"); 
    return (
      <View style={styles.container}>
        <Text>You are on the Gil Nav Screen page</Text>   
