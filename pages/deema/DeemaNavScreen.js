...
class DeemaNavScreen extends Component {
  render() {
    const campusMap = require("../../screenImages/deemaNav.png"); 
    return (
      <View style={styles.container}>
        <Text>You are on the Deema Nav Screen page</Text>   
