...
class AnemoneTwoScreen extends Component {
  render() {
    const campusMap = require("../../screenImages/anemone2Nav.png"); 
    return (
      <View style={styles.container}>
        <Text>You are on the Anemone Two Nav Screen page</Text>   
...
export default AnemoneTwoScreen;