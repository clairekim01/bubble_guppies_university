...
class AnemoneThreeScreen extends Component {
  render() {
    const campusMap = require("../../screenImages/anemone3Nav.png"); 
    return (
      <View style={styles.container}>
        <Text>You are on the Anemone Three Nav Screen page</Text>   
...
export default AnemoneThreeScreen;