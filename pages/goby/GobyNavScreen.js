...
class GobyNavScreen extends Component {
  render() {
    const campusMap = require("../../screenImages/gobyNav.png"); 
    return (
      <View style={styles.container}>
        <Text>You are on the Goby Nav Screen page</Text>   
